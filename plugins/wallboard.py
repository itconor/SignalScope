...
#wb-ticker{
  ...
  padding:6px 0;display:flex;align-items:center;overflow:hidden;height:36px;
}
#wb-ticker-label{
...
.tk-item{font-size:14px;color:var(--mu);padding-right:60px;display:inline-flex;align-items:center;gap:6px}
